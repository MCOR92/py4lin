...
#set is unordered set of unique options we are testing to see if a specific value is member of the set.

for line in open("/etc/passwd"):
    #loop is scanning the passwd file for what we want in the set above.
    split = line.split(":")
